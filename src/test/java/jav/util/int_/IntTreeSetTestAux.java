...
public class IntTreeSetTestAux extends IntTreeSet {
    ...
    private static class TreeNodeAdapter implements RBTreeUtil.NodeAdapter {
        ...
        public Object getParent(Object node) {
            return ((Entry)node).getParent();
        }

        @Override
        public Object getRight(Object node) {
            return ((Entry)node).getRight();
        }

        @Override
        public Object getLeft(Object node) {
            return ((Entry)node).getLeft();
        }
        ...
        public boolean isRed(Object node) {
            return ((Entry)node).isRed();
        }

        @Override
        public boolean isBlack(Object node) {
            return ((Entry)node).isBlack();
        }
        
        @Override
        public boolean valueEquals(Object node, Object value){
            return (((Entry)node)).getValue()==((Number)value).intValue();
        }
        
        @Override
        public int valueCompare(Object node, Object value){
            return (((Entry)node)).getValue()<((Number)value).intValue()? -1 : 
                    (((Entry)node)).getValue()>((Number)value).intValue()? 1 : 0;
        }
    }
}
