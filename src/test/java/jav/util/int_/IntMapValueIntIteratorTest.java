...
public class IntMapValueIntIteratorTest extends IntIteratorTest {

    private final IntMapProvider intMapProvider;

    public IntMapValueIntIteratorTest(IntMapProvider intMapProvider) {
    ...
    protected PrimitiveIterator.OfInt iterator() {
        return intMapProvider.getMap().intValues().iterator();
    }
