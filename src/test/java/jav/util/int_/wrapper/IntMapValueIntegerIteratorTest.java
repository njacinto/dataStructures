...
public class IntMapValueIntegerIteratorTest extends IntegerIteratorTest {

    private final IntMapProvider intMapProvider;

    public IntMapValueIntegerIteratorTest(IntMapProvider intMapProvider) {
    ...
    protected Iterator<Integer> iterator() {
        return new IntegerMapWrapper(intMapProvider.getMap()).values().iterator();
    }
    ...
    protected Iterator<Integer> iterator(int... nums) {
        ...
        return new IntegerMapWrapper(map).values().iterator();
    }
