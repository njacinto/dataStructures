...
public class LongHashTreeMapTestAux extends LongHashTreeMap {
    ...
    private static class TreeNodeAdapter implements RBTreeUtil.NodeAdapter {
        ...
        public int valueCompare(Object node, Object value){
            return (((MapTreeNode)node)).getValue()<((Number)value).longValue()? -1 : 
                    (((MapTreeNode)node)).getValue()>((Number)value).longValue()? 1 : 0;
        }
    }
}
