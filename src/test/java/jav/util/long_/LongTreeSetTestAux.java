...
public class LongTreeSetTestAux extends LongTreeSet {
    ...
    private static class TreeNodeAdapter implements RBTreeUtil.NodeAdapter {
        ...
        public Object getParent(Object node) {
            return ((TreeSetNode)node).getParent();
        }

        @Override
        public Object getRight(Object node) {
            return ((TreeSetNode)node).getRight();
        }

        @Override
        public Object getLeft(Object node) {
            return ((TreeSetNode)node).getLeft();
        }

        @Override
        public Object getValue(Object node) {
            return ((TreeSetNode)node).getValue();
        }

        @Override
        public boolean isRed(Object node) {
            return ((TreeSetNode)node).isRed();
        }

        @Override
        public boolean isBlack(Object node) {
            return ((TreeSetNode)node).isBlack();
        }
        
        @Override
        public boolean valueEquals(Object node, Object value){
            return (((TreeSetNode)node)).getValue()==((Number)value).longValue();
        }
        
        @Override
        public int valueCompare(Object node, Object value){
            return (((TreeSetNode)node)).getValue()<((Number)value).longValue()? -1 : 
                    (((TreeSetNode)node)).getValue()>((Number)value).longValue()? 1 : 0;
        }
    }
}
