...
public class LongMapKeyLongIteratorTest extends LongIteratorTest {

    private final LongMapProvider longMapProvider;

    public LongMapKeyLongIteratorTest(LongMapProvider longMapProvider) {
    ...
    protected PrimitiveIterator.OfLong iterator() {
        return longMapProvider.getMap().longKeySet().iterator();
    }
    ...
    protected PrimitiveIterator.OfLong iterator(long... nums) {
        ...
        return map.longKeySet().iterator();
    }
