...
public class LongObjectHashTreeMapTestAux extends LongObjectHashTreeMap<Long> {
    ...
    private static class TreeNodeAdapter implements RBTreeUtil.NodeAdapter {
        ...
        public Object getValue(Object node) {
            return ((MapTreeNode)node).getKey();
        }
        ...
        public boolean valueEquals(Object node, Object value){
            return (((MapTreeNode)node)).getKey()==((Number)value).longValue();
        }
        
        @Override
        public int valueCompare(Object node, Object value){
            return (((MapTreeNode)node)).getKey()<((Number)value).longValue()? -1 : 
                    (((MapTreeNode)node)).getKey()>((Number)value).longValue()? 1 : 0;
        }
    }
}
