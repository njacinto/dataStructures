...
public class IntObjectTreeMapTestAux extends IntObjectTreeMap<Integer> {
    ...
    private static class TreeNodeAdapter implements RBTreeUtil.NodeAdapter {
        ...
        public boolean valueEquals(Object node, Object value){
            return (((TreeNode)node)).getKey()==((Number)value).intValue();
        }
        
        @Override
        public int valueCompare(Object node, Object value){
            return (((TreeNode)node)).getKey()<((Number)value).intValue()? -1 : 
                    (((TreeNode)node)).getKey()>((Number)value).intValue()? 1 : 0;
        }
    }
}
