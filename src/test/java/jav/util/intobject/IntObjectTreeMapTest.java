...
public class IntObjectTreeMapTest extends IntObjectMapTest{

    @Override
    protected IntObjectMap<Integer> map() {
        return new IntObjectTreeMap<Integer>();
    }
    
    public IntObjectTreeMapTest() {
    }
    
    @Test
    public void testDepth(){
        IntObjectTreeMapTestAux instance = new IntObjectTreeMapTestAux();
        //
    ...
    public void testDelete_Root(){
        ...
        testDeleteNode(new IntObjectTreeMapTestAux(), 
                data.getRemoveValue(),
                data.getStartValue(),
    ...
    private static void testDeleteNode(IntObjectTreeMapTestAux instance, int removeKey, 
