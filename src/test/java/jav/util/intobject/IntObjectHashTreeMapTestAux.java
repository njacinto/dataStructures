...
public class IntObjectHashTreeMapTestAux extends IntObjectHashTreeMap<Integer> {
    ...
    private static class TreeNodeAdapter implements RBTreeUtil.NodeAdapter {
        ...
        public boolean valueEquals(Object node, Object value){
            return (((MapTreeNode)node)).getKey()==((Number)value).intValue();
        }
        
        @Override
        public int valueCompare(Object node, Object value){
            return (((MapTreeNode)node)).getKey()<((Number)value).intValue()? -1 : 
                    (((MapTreeNode)node)).getKey()>((Number)value).intValue()? 1 : 0;
        }
    }
}
